...
{	
	...
	{
		type(ForNav.Report; ForNavReport70154){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70154){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70154 "ForNAV Tax Purchase Quote"
{

	Caption = 'Purchase Quote';
	WordLayout = './Layouts/ForNAV Tax Purchase Quote.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70154;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70154;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70154);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70154;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
