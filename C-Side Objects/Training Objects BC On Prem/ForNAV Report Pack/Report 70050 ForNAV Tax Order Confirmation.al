...
{	
	...
	{
		type(ForNav.Report; ForNavReport70050){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70050){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70050 "ForNAV Tax Order Confirmation"
{

	Caption = 'Order';
	WordLayout = './Layouts/ForNAV Tax Order Confirmation.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70050;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70050;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70050);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70050;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
