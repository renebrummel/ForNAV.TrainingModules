...
{	
	...
	{
		type(ForNav.Report; ForNavReport70235){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70235){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70235 "ForNAV Purchase Statistics"
{

	Caption = 'Purchase Statistics';
	WordLayout = './Layouts/ForNAV Purchase Statistics.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70235;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70235;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70235);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70235;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
	...
	begin
		...
		case DataItemId of
			...
			'PurchInvoiceHeader':
				with PurchInvoiceHeader do case Operation of
					'Add': begin
			...
			'PurchCrMemoHeader':
				with PurchCrMemoHeader do case Operation of
					'Add': begin
						ReportForNav.AddTotal(DataItemId,0,Amount);
						ReportForNav.AddTotal(DataItemId,1,"Amount Including VAT");
					end;
