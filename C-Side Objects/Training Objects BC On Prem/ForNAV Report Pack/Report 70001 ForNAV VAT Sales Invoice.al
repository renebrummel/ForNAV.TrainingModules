...
{	
	...
	{
		type(ForNav.Report; ForNavReport70001){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70001){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70001 "ForNAV VAT Sales Invoice"
{

	Caption = 'Invoice';
	WordLayout = './Layouts/ForNAV VAT Sales Invoice.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70001;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70001;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70001);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70001;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
