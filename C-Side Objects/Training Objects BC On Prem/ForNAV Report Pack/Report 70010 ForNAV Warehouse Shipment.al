...
{	
	...
	{
		type(ForNav.Report; ForNavReport70010){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70010){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70010 "ForNAV Warehouse Shipment"
{
	Caption = 'Warehouse Shipment';
	WordLayout = './Layouts/ForNAV Warehouse Shipment.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70010;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70010;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70010);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70010;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
