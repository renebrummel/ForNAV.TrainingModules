...
{	
	...
	{
		type(ForNav.Report; ForNavReport70526){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70526){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70526 "ForNAV Template - Landscape"
{

	Caption = 'Template Landscape';
	WordLayout = './Layouts/ForNAV Template - Landscape.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70526;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70526;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70526);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70526;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
