...
{	
	...
	{
		type(ForNav.Report; ForNavReport70100){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70100){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70100 "ForNAV VAT Purchase Order"
{

	Caption = 'Purchase Order';
	WordLayout = './Layouts/ForNAV VAT Purchase Order.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70100;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70100;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70100);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70100;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
