...
{	
	...
	{
		type(ForNav.Report; ForNavReport70150){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70150){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70150 "ForNAV Tax Purchase Order"
{

	Caption = 'Purchase Order';
	WordLayout = './Layouts/ForNAV Tax Purchase Order.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70150;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70150;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70150);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70150;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
