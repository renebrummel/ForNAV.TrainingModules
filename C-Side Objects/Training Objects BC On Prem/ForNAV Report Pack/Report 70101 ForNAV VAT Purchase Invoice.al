...
{	
	...
	{
		type(ForNav.Report; ForNavReport70101){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70101){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70101 "ForNAV VAT Purchase Invoice"
{

	Caption = 'Purchase Invoice';
	WordLayout = './Layouts/ForNAV VAT Purchase Invoice.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70101;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70101;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70101);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70101;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
