...
{	
	...
	{
		type(ForNav.Report; ForNavReport70501){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70501){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70501 "ForNAV API Example VAT Curr."
{

	Caption = 'Invoice';
	WordLayout = './Layouts/ForNAV API Example VAT Curr..docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70501;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70501;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70501);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70501;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
