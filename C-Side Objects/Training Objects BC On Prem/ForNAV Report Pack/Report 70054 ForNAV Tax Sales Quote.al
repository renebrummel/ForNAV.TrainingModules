...
{	
	...
	{
		type(ForNav.Report; ForNavReport70054){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70054){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70054 "ForNAV Tax Sales Quote"
{

	Caption = 'Sales Quote';
	WordLayout = './Layouts/ForNAV Tax Sales Quote.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70054;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70054;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70054);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70054;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
