...
{	
	...
	{
		type(ForNav.Report; ForNavReport70051){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70051){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70051 "ForNAV Tax Sales Invoice"
{

	Caption = 'Invoice';
	WordLayout = './Layouts/ForNAV Tax Sales Invoice.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70051;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70051;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70051);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70051;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
