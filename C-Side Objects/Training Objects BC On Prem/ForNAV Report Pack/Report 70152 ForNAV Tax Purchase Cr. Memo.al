...
{	
	...
	{
		type(ForNav.Report; ForNavReport70152){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70152){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70152 "ForNAV Tax Purchase Cr. Memo"
{

	Caption = 'Purchase Quote';
	WordLayout = './Layouts/ForNAV Tax Purchase Cr. Memo.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70152;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70152;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70152);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70152;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
