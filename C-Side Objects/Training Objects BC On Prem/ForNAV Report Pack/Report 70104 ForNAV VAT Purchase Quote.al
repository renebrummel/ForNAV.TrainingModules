...
{	
	...
	{
		type(ForNav.Report; ForNavReport70104){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70104){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70104 "ForNAV VAT Purchase Quote"
{

	Caption = 'Purchase Quote';
	WordLayout = './Layouts/ForNAV VAT Purchase Quote.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70104;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70104;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70104);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70104;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
