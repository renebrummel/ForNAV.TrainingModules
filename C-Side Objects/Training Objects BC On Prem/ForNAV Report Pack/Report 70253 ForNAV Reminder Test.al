...
{	
	...
	{
		type(ForNav.Report; ForNavReport70253){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70253){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70253 "ForNAV Reminder Test"
{
	Caption = 'Reminder Test';
	WordLayout = './Layouts/ForNAV Reminder Test.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70253;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70253;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70253);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70253;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
