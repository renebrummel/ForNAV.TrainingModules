...
{	
	...
	{
		type(ForNav.Report; ForNavReport70002){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70002){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70002 "ForNAV VAT Credit Memo"
{

	Caption = 'Credit Memo';
	WordLayout = './Layouts/ForNAV VAT Credit Memo.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70002;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70002;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70002);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70002;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
