...
{	
	...
	{
		type(ForNav.Report; ForNavReport70527){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70527){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70527 "ForNAV Template"
{

	Caption = 'Template';
	WordLayout = './Layouts/ForNAV Template.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70527;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70527;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70527);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70527;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
