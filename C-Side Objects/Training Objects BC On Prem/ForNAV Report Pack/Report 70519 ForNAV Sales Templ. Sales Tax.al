...
{	
	...
	{
		type(ForNav.Report; ForNavReport70519){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70519){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70519 "ForNAV Sales Templ. Sales Tax"
{

	Caption = 'Sales Template Sales Tax';
	WordLayout = './Layouts/ForNAV Sales Templ. Sales Tax.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70519;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70519;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70519);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70519;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
