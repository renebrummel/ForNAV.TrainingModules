...
{	
	...
	{
		type(ForNav.Report; ForNavReport70528){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70528){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70528 "ForNAV Purchase Template"
{

	Caption = 'Purchase Template';
	WordLayout = './Layouts/ForNAV Purchase Template.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70528;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70528;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70528);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70528;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
