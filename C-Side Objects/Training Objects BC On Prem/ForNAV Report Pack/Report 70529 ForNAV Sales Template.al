...
{	
	...
	{
		type(ForNav.Report; ForNavReport70529){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70529){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70529 "ForNAV Sales Template"
{

	Caption = 'Sales Template';
	WordLayout = './Layouts/ForNAV Sales Template.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70529;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70529;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70529);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70529;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
