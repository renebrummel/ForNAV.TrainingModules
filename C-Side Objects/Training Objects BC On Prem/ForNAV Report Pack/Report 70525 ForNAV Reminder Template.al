...
{	
	...
	{
		type(ForNav.Report; ForNavReport70525){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70525){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70525 "ForNAV Reminder Template"
{
	Caption = 'Reminder Template';
	WordLayout = './Layouts/ForNAV Reminder Template.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70525;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70525;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70525);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70525;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
