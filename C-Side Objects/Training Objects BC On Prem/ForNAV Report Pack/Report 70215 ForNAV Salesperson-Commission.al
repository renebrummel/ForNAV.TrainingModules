...
{	
	...
	{
		type(ForNav.Report; ForNavReport70215){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70215){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70215 "ForNAV Salesperson-Commission"
{

	Caption = 'Salesperson Commission';
	WordLayout = './Layouts/ForNAV Salesperson-Commission.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70215;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70215;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70215);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70215;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
	...
	begin
		...
		case DataItemId of
			'SalespersonPurchaser':
				with SalespersonPurchaser do case Operation of
					'Add': begin
