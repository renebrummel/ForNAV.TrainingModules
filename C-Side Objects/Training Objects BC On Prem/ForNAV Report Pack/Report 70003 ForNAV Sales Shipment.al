...
{	
	...
	{
		type(ForNav.Report; ForNavReport70003){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70003){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70003 "ForNAV Sales Shipment"
{

	Caption = 'Sales Shipment';
	WordLayout = './Layouts/ForNAV Sales Shipment.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70003;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70003;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70003);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70003;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
