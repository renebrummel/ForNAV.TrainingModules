...
{	
	...
	{
		type(ForNav.Report; ForNavReport70011){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70011){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70011 "ForNAV Warehouse Receipt"
{
	Caption = 'Warehouse Receipt';
	WordLayout = './Layouts/ForNAV Warehouse Receipt.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70011;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70011;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70011);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70011;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
