...
{	
	...
	{
		type(ForNav.Report; ForNavReport70151){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70151){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70151 "ForNAV Tax Purchase Invoice"
{

	Caption = 'Purchase Invoice';
	WordLayout = './Layouts/ForNAV Tax Purchase Invoice.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70151;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70151;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70151);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70151;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
