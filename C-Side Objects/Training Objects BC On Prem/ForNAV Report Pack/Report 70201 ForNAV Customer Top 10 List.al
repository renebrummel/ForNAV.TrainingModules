...
{	
	...
	{
		type(ForNav.Report; ForNavReport70201){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70201){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70201 "ForNAV Customer Top 10 List"
{

	Caption = 'Customer Top 10 List';
	WordLayout = './Layouts/ForNAV Customer Top 10 List.docx'; DefaultLayout = Word;
	...
	dataset
	{
		DataItem(Customer;Customer)
		{
			...
			RequestFilterFields = "No.",Name,"Customer Posting Group","Country/Region Code","Date Filter";
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70201;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70201;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70201);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70201;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
