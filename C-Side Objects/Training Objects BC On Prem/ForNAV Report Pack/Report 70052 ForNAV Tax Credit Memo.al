...
{	
	...
	{
		type(ForNav.Report; ForNavReport70052){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70052){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70052 "ForNAV Tax Credit Memo"
{

	Caption = 'Credit Memo';
	WordLayout = './Layouts/ForNAV Tax Credit Memo.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70052;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70052;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70052);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70052;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
