...
{	
	...
	{
		type(ForNav.Report; ForNavReport70518){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70518){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70518 "ForNAV Tax Purchase Templ."
{

	Caption = 'Purchase Template Sales Tax';
	WordLayout = './Layouts/ForNAV Tax Purchase Templ..docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70518;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70518;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70518);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70518;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
