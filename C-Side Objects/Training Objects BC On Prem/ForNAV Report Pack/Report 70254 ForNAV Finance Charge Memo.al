...
{	
	...
	{
		type(ForNav.Report; ForNavReport70254){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70254){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70254 "ForNAV Finance Charge Memo"
{
	Caption = 'Finance Charge Memo';
	WordLayout = './Layouts/ForNAV Finance Charge Memo.docx'; DefaultLayout = Word;

	dataset
	{
		DataItem(Header;"Issued Fin. Charge Memo Header")
		{
			column(ReportForNavId_1000000000; 1000000000) {}
			DataItem(Line;"Issued Fin. Charge Memo Line")
			{
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70254;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70254;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70254);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70254;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
