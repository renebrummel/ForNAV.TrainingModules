...
{	
	...
	{
		type(ForNav.Report; ForNavReport70220){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream70220){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 70220 "ForNAV Aged Accounts Receivbl."
{

	Caption = 'Aged Accounts Receivables';
	WordLayout = './Layouts/ForNAV Aged Accounts Receivbl..docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport70220;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport70220;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream70220);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream70220;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
