...
{	
	...
	{
		type(ForNav.Report; ForNavReport72000){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream72000){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 72000 "ForNAV VAT Order Confirmation"
{

	Caption = 'Order';
	WordLayout = './Layouts/ForNAV VAT Order Confirmation.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport72000;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport72000;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream72000);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream72000;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
