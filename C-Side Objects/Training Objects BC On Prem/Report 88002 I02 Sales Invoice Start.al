...
{	
	...
	{
		type(ForNav.Report; ForNavReport89002){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89002){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89002 "I02 Sales Invoice Start(88002)"
{
	WordLayout = './Layouts/I02 Sales Invoice Start.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89002;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89002;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89002);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89002;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
