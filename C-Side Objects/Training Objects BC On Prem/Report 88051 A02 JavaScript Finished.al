...
{	
	...
	{
		type(ForNav.Report; ForNavReport89051){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89051){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89051 "A02 JavaScript Finished(88051)"
{
	WordLayout = './Layouts/A02 JavaScript Finished.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89051;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89051;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89051);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89051;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
