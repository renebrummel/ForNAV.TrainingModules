dotnet // --> Reports ForNAV Autogenerated code - do not delete or modify
{
    ...
    {
        type(ForNav.Report; ForNavReport89000) { }
    }
    assembly("mscorlib")
    {
        Version = '4.0.0.0';
        type("System.IO.Stream"; SystemIOStream89000) { }
    }
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89000 "B02 Customer Top 10(88000)"
{
    WordLayout = './Layouts/B02 Customer Top 10.docx';
    DefaultLayout = Word;
    ...
    var
        [WithEvents]
        ReportForNav: DotNet ForNavReport89000;
        [RunOnClient]
        ReportForNavClient: DotNet ForNavReport89000;
    ...
    trigger ReportForNav::OnPrint(InStream: DotNet SystemIOStream89000);
    var
    ...
    trigger ReportForNav::OnPrintPreview(InStream: DotNet SystemIOStream89000; Preview: Boolean);
    var
        ClientFileName: Text[255];
    begin
        // This code is created automatically every time Reports ForNAV saves the report.
