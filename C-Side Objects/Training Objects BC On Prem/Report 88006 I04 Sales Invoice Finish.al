...
{	
	...
	{
		type(ForNav.Report; ForNavReport89006){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89006){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89006 "I04 Sales Invoice Finish(88006)"
{
	WordLayout = './Layouts/I04 Sales Invoice Finish.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89006;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89006;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89006);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89006;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
