...
{	
	...
	{
		type(ForNav.Report; ForNavReport89007){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89007){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89007 "B03 - Sales Invoice(88007)"
{
	WordLayout = './Layouts/B03 - Sales Invoice.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89007;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89007;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89007);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89007;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
