...
{	
	...
	{
		type(ForNav.Report; ForNavReport89005){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89005){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89005 "Cust. Entries List (Classic)(88005)"
{
	WordLayout = './Layouts/Cust. Entries List (Classic).docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89005;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89005;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89005);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89005;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
	...
	begin
		...
		case DataItemId of
			'CustLedgerEntry':
				with "Cust. Ledger Entry" do case Operation of
					'Add': begin
