...
{	
	...
	{
		type(ForNav.Report; ForNavReport89053){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89053){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89053 "A04 Template Finished(88053)"
{
	WordLayout = './Layouts/A04 Template Finished.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89053;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89053;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89053);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89053;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
