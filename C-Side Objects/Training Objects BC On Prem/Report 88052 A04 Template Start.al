...
{	
	...
	{
		type(ForNav.Report; ForNavReport89052){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89052){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89052 "A04 Template Start(88052)"
{
	WordLayout = './Layouts/A04 Template Start.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89052;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89052;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89052);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89052;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
