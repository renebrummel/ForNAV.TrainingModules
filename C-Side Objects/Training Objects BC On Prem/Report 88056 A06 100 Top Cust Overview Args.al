...
{	
	...
	{
		type(ForNav.Report; ForNavReport89056){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89056){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89056 "A06 100 Top Cust Overview Args(88056)"
{
	WordLayout = './Layouts/A06 100 Top Cust Overview Args.docx'; DefaultLayout = Word;
		...
		layout
		{
			area(content)
			{
				group("Filter Fields")
				{
					...
					field("Args.""Customer No.""";Args."Customer No.")
					{
						ApplicationArea = Basic;
						Caption = 'Customer No.';
						TableRelation = Customer;
					}
					field("Args.""Global Dimension 1 Code""";Args."Global Dimension 1 Code")
					{
						ApplicationArea = Basic;
						Caption = 'Dimension 1 Code';
						TableRelation = "Dimension Value".Code where ("Global Dimension No."=const(1));
					}
					field("Args.""Global Dimension 2 Code""";Args."Global Dimension 2 Code")
					{
						ApplicationArea = Basic;
						Caption = 'Dimension 2 Code';
						TableRelation = "Dimension Value".Code where ("Global Dimension No."=const(2));
					}
					field("Args.""Salesperson Code""";Args."Salesperson Code")
					{
						ApplicationArea = Basic;
						Caption = 'Salesperson Code';
						TableRelation = "Salesperson/Purchaser";
					}
					field("Args.""Country/Region Code""";Args."Country/Region Code")
					{
						ApplicationArea = Basic;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89056;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89056;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89056);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89056;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
