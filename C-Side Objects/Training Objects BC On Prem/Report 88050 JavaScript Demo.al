...
{	
	...
	{
		type(ForNav.Report; ForNavReport89050){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream89050){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89050 "JavaScript Demo(88050)"
{
	WordLayout = './Layouts/JavaScript Demo.docx'; DefaultLayout = Word;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport89050;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport89050;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream89050);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream89050;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
