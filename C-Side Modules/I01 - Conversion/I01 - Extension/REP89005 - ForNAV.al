dotnet // --> Reports ForNAV Autogenerated code - do not delete or modify
{
    ...
    {
        type(ForNav.Report; ForNavReport88005) { }
    }
    assembly("mscorlib")
    {
        Version = '4.0.0.0';
        type("System.IO.Stream"; SystemIOStream88005) { }
    }
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 89005 "Cust. Entries List (AL)"
{
    WordLayout = './Layouts/Cust. Entries List (Classic).docx';
    DefaultLayout = Word;
    ...
    var
        [WithEvents]
        ReportForNav: DotNet ForNavReport88005;
        [RunOnClient]
        ReportForNavClient: DotNet ForNavReport88005;
    ...
    trigger ReportForNav::OnPrint(InStream: DotNet SystemIOStream88005);
    var
    ...
    trigger ReportForNav::OnPrintPreview(InStream: DotNet SystemIOStream88005; Preview: Boolean);
    var
        ClientFileName: Text[255];
    begin
        // This code is created automatically every time Reports ForNAV saves the report.
