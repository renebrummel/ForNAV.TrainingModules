...
{	
	...
	{
		type(ForNav.Report; ForNavReport56011){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream56011){}   
	}
...
Report 56011 "ForNAV VAT Purch Invoice Track"
{
	...
	RDLCLayout = './Layouts/ForNAV VAT Purch Invoice Track.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport56011;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport56011;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream56011);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream56011;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
