...
{	
	...
	{
		type(ForNav.Report; ForNavReport56001){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream56001){}   
	}
...
Report 56001 "ForNAV VAT Sales Inv Track"
{
	...
	RDLCLayout = './Layouts/ForNAV VAT Sales Inv Track.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		DataItem(Header;"Sales Invoice Header")
		{
			...
			CalcFields = Amount,"Amount Including VAT","Work Description";
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport56001;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport56001;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream56001);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream56001;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
