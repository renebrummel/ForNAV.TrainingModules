...
{	
	...
	{
		type(ForNav.Report_5_2_0_1903; ForNavReport80110_v5_2_0_1903){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream80110){}   
		type("System.IO.Path"; System_IO_Path80110) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 80110 "ForNAV API Invoice"
{
	Caption = 'Training Invoice';
	RDLCLayout = '.\Layouts\ForNAV API Invoice.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport80110_v5_2_0_1903;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport80110_v5_2_0_1903;
	...
	var
		...
		path: DotNet System_IO_Path80110;
	...
	trigger ReportForNav::OnPrint(InStream : DotNet SystemIOStream80110);
	var
	...
	trigger ReportForNav::OnPrintPreview(InStream : DotNet SystemIOStream80110;Preview : Boolean);
	var
		ClientFileName : Text[255];
	begin
		// This code is created automatically every time Reports ForNAV saves the report.
