...
{	
	...
	{
		type(ForNav.Report_5_2_0_1903; ForNavReport80100_v5_2_0_1903){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
...
Report 80100 "ForNAV AddReports Invoice"
{
	...
	RDLCLayout = '.\Layouts\ForNAV AddReports Invoice.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport80100_v5_2_0_1903;
		[RunOnClient]
		ReportForNavClient : DotNet ForNavReport80100_v5_2_0_1903;
