dotnet // --> Reports ForNAV Autogenerated code - do not delete or modify
{
    ...
    {
        type(ForNav.Report_5_2_0_1903; ForNavReport50001_v5_2_0_1903) { }
    }
    assembly("mscorlib")
    {
        Version = '4.0.0.0';
...
Report 80101 "ForNAV Create New Reports"
{
    Caption = 'Training List';
    RDLCLayout = '.\Layouts\ForNAV Create New Reports.rdlc';
    DefaultLayout = RDLC;
    ...
    var
        [WithEvents]
        ReportForNav: DotNet ForNavReport50001_v5_2_0_1903;
        [RunOnClient]
        ReportForNavClient: DotNet ForNavReport50001_v5_2_0_1903;
    ...
    trigger ReportForNav::OnPrint(InStream: DotNet SystemIOStream50001);
    var
    ...
    trigger ReportForNav::OnPrintPreview(InStream: DotNet SystemIOStream50001; Preview: Boolean);
    var
        ClientFileName: Text[255];
    begin
        // This code is created automatically every time Reports ForNAV saves the report.
